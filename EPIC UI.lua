...
function lib:Window(text,textcolor, preset,thesize,gra, closebind)
    ...
    Main.BackgroundColor3 = Color3.fromRGB(252, 107 ,100)
    ...
    function tabhold:Tab(text,defaultcolor)
        ...
        coroutine.wrap(
            function()
                while wait() do
                    if amounttab > 7 then
                        Tab.Size = UDim2.new(0, 373, 0, 37.1428571*amounttab)
                    else
        ...
        local tabcontent = {}
        function tabcontent:Refresh(txt)
            TabTitle.Text = txt
        end
        function tabcontent:Button(text, callback)
            ...
            Button.Name = "Button"
            Button.Parent = Tab
            Button.BackgroundColor3 = defaultcolor or Color3.fromRGB(34, 34, 34)
            ...
            local BtnFunc = {}
            function BtnFunc:Refresh(txt)
                ButtonTitle.Text = txt
            end
            return BtnFunc
        end
        function tabcontent:Toggle(text, callback)
            ...
            Toggle.Name = "Toggle"
            Toggle.Parent = Tab
            Toggle.BackgroundColor3 = defaultcolor or Color3.fromRGB(34, 34, 34)
            ...
            local togglefunc = {}
            function togglefunc:Refresh(txt)
                ToggleTitle.Text = txt
            end
        end
        function tabcontent:Slider(text, min, max, start, callback)
            ...
            Slider.Name = "Slider"
            Slider.Parent = Tab
            Slider.BackgroundColor3 = defaultcolor or Color3.fromRGB(34, 34, 34)
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            Dropdown.Parent = Tab
            Dropdown.BackgroundColor3 = defaultcolor or Color3.fromRGB(34, 34, 34)
            ...
            local DropDownFunc = {}
            function DropDownFunc:Refresh(new)
                for _,a in pairs(DropItemHolder:GetChildren()) do
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            Colorpicker.BackgroundColor3 = defaultcolor or Color3.fromRGB(34, 34, 34)
        ...
        function tabcontent:Label(text)
            ...
            Label.Name = "Button"
            Label.Parent = Tab
            Label.BackgroundColor3 = defaultcolor or Color3.fromRGB(34, 34, 34)
